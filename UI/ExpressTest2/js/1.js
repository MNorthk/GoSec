	 ...
	 $.post("/Login/Login",//登陆页面用
	 	...
	 	function(d){
	 	    switch (d) {
	 	        ...
	 	        case "k100": location.href = "index.html"; break;
		...
		function(d){
		    switch(d)
		    {
		        ...
		        default:
		            ...
		            location.href = "../ExpressTest2/sign.html";//
		            //$("#bf-form").attr("class", "pm-hide");
		            //$("#regi-form").attr("class", "pm-show");
		            document.getElementById("renumber").value=d.StudentId;
		           // $("#re-number").val(d.StudentId);
		            $("#re-name").attr('disabled','true');
